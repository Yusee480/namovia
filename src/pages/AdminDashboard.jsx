    ...
    <div className="space-y-8 animate-fadeIn relative w-full">
      ...
      <div className="bg-white dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <button onClick={() => handleTabChange('Notifications')} className="flex items-center justify-center space-x-2 p-3 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 text-slate-800 dark:text-white rounded-xl text-xs font-bold transition-all"><FaPlus /> <span>Publish News</span></button>
          <button onClick={() => alert('Compiling latest metric reports for download...')} className="flex items-center justify-center space-x-2 p-3 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-xs font-bold transition-all shadow-sm"><FaCloudDownloadAlt /> <span>Get Report</span></button>
